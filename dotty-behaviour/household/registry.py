...
log = logging.getLogger("dotty-behaviour.household")
...
try:
    ...
    log.warning(
        ...
        "Add `PyYAML>=6.0,<7` to dotty-behaviour/requirements.txt and reinstall."
    )

DEFAULT_HOUSEHOLD_PATH = "/var/lib/dotty-behaviour/state/household.yaml"
